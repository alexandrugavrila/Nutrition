...
_port = os.getenv("DEV_BACKEND_PORT")
if not _port:
    pytest.skip("DEV_BACKEND_PORT not set; skipping e2e suite", allow_module_level=True)
...
try:
    ...
    pytest.skip(
        "Backend not reachable on DEV_BACKEND_PORT; skipping e2e suite",
